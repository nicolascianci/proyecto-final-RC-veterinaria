...
const Servicios = () => {
  ...
  <section class="row d-flex justify-content-center m-5">
    ...
    <div class="ds-servicios card w-25 border-0 rounded-0 p-2 m-0">
    ...
    <div class="ds-servicios card-servicios card w-25 border-0 rounded-0 p-2 m-0">
  ...
  <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Radiolog´pia Digital</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
